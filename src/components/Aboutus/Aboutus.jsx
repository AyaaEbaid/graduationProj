            ...
            {[photo3, photo2, photo1].map((photo, index) => (
              ...
              >
                <div className="w-72 h-72">
                  <img src={photo} alt={`icon${index + 1}`} className="w-full h-full object-cover" />
                </div>
                <p className="mt-6 text-gray-700 text-lg leading-loose text-center font-medium">
                  {index === 0 && `"Hanshatobhalak" is an online platform that connects apartment owners 
                  ...
                  {index === 1 && `Account registration for apartment owners, craftsmen, and store owners. 
                  ...
                  {index === 2 && `Your ultimate destination for finishing projects, where apartment owners  
