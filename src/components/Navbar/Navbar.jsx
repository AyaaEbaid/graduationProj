      ...
      <nav className="bg-teal-600 border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex  items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            {token?<> <div className="relative ltr:md:right-4 mx-4 flex flex-col items-start">
              <button
              ...
              <AnimatePresence>
                {isOpen && (
                  <motion.div
                    ...
                    animate="visible"
                    exit="hidden"
                    className="absolute rtl:left-[-70px] ltr:start-[-150px] mt-12 z-50" // يضع حقل الإدخال تحت الأيقونة
                  >
                    <motion.input
                      type="text"
            ...
            </div></>:<div className="items-center pr-3 justify-between hidden w-full md:flex md:w-auto md:order-1">
